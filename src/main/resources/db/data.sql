insert into user_tb (username, password, email, PROFILE, created_at) values ('ssar','1234','ssar@nate.com', '/images/default_profile.png', now());
insert into user_tb (username, password, email, PROFILE, created_at) values ('love','1234','love@nate.com', '/images/default_profile.png', now());
