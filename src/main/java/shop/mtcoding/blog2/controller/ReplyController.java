...
public class ReplyController {
    ...
    public ResponseEntity<?> save(@RequestBody ReplySaveReqDto rdto){
        ...
        int replyId = replyService.댓글쓰기(rdto, principal.getId());
        System.out.println("테스트 : "+ replyId);
        // return "redirect:/board/detail/"+rdto.getBoardId();
        return new ResponseEntity<>(new ResponseDto<>(1, "댓글 쓰기 성공", replyId), HttpStatus.OK);
    }
